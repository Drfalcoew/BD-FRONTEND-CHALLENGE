    ...
    <form onSubmit={handleSubmit} className='contact-form'>
        <div className='contact-form-outer-group'>
            <div className='contact-form-group contact-form-double'>
                <label className='contact-form-label' htmlFor='address1'>Address *</label>
                <input className='contact-form-field' defaultValue={formData.address || ''} type='text' id='address1' name='address1' required />
            </div>
            <div className='contact-form-group contact-form-double'>
                <label className='contact-form-label' htmlFor='address2'>Apartment, Suite, etc.</label>
        ...
        <div className='contact-form-outer-group'>
            <div className='contact-form-group contact-form-triple'>
                <label className='contact-form-label' htmlFor='country'>Country *</label>
            ...
            <div className='contact-form-group contact-form-triple'>
                <label className='contact-form-label' htmlFor='city'>City *</label>
                <input className='contact-form-field contact-form-triple' defaultValue={formData.city || ''} type='text' id='city' name='city' required />
            </div>
            <div className='contact-form-group contact-form-triple'>
                <label className='contact-form-label' htmlFor='zipCode'>Zipcode *</label>
        ...
        <div className='contact-form-group'>
            <label className='contact-form-label' htmlFor='phoneNumber'>Phone Number</label>
